            ...
            //    $.ajax(url).done(function(xml) {
                ...
                //fetch(urlSCBg).then(function(xml) {
                   var prom = $.ajax(urlSCBg).then(function(xml){
                    ...
                    newContent.innerHTML =  mobileThingsDB[i].id;
                    document.getElementById('selectSensor').appendChild(newContent);
...
function CreateHighlightAttributes(placemarkAttr){
      ...
      highlightAttributes.imageScale = 6.5;
...
/*
function CreateMobThingsPlacemark(lat,lon,imgSource,params){
      ...
      //placemarkMobThLayer = new WorldWind.RenderableLayer("Mobile Things Placemarks");
      ...
      placemark.highlightAttributes = highlightAttributes;
        ...
        if(params.providerID == "safecast"){
            placemark.cpm = params.cpm;
            placemark.providerName = "Safecast";
            placemark.time=params.time;
            placemark.sievert = params.name;
        }
