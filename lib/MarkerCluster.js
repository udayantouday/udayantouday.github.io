 ...
 //define(['../lib/supercluster.min', '../worldwind.min'], function (supercluster, wwe) {
    ...
    MarkerCluster.prototype.picking = function () {
        ...
        if (!self.globe.eventListeners.addedListeners) {
            ...
            this.handleClickFunc = handleClick;
            this.handlePickFunc = handlePick;
        }
    };

     /**
     * Remove listeners for mouseover and click
     */

    MarkerCluster.prototype.removePicking = function () {
        if (this.globe.eventListeners.addedListeners == true) {
            this.globe.eventListeners.addedListeners = false;
            this.globe.removeEventListener("mousemove", this.handlePickFunc);
            this.globe.removeEventListener("click", this.handleClickFunc);
            //this.handleClickFunc = handleClick;
            //this.handlePickFunc = handlePick;
        }
    }
    ...
    /**
     * Return listeners for mouseover and click
     */

    MarkerCluster.prototype.addPicking = function () {
        if (this.globe.eventListeners.addedListeners == false) {
            this.globe.eventListeners.addedListeners = true;
            this.globe.addEventListener("mousemove", this.handlePickFunc);
            this.globe.addEventListener("click", this.handleClickFunc);
            //this.handleClickFunc = handleClick;
            //this.handlePickFunc = handlePick;
        }
    }
